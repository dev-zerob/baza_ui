...
void main() {
  ...
  // TODO: Apple 서드 파티 테스트 코드 작성 (현재 임시 테스트 코드)

  testWidgets(
    'Apple 로그인 완료시 "유저 정보 입력" 화면으로 이동합니다.',
    (WidgetTester tester) async {
      await tester.pumpWidget(
        MaterialApp(
          initialRoute: ROUTE_APPLE_LOGIN,
      ...
      expect(find.byType(RegisterUserInfoScreen), findsOneWidget);
    },
  );
}
